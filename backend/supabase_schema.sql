...
-- ------------------------------------------------------------
-- RLS desativado (backend usa service key diretamente)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Permissões para a role anon (chave publishable do frontend)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Permissões para a role authenticated (service key)
-- ------------------------------------------------------------
GRANT ALL ON TABLE protocols      TO authenticated;
GRANT ALL ON TABLE query_history  TO authenticated;
GRANT ALL ON TABLE usuarios       TO authenticated;
GRANT USAGE, SELECT ON SEQUENCE protocols_id_seq     TO authenticated;
GRANT USAGE, SELECT ON SEQUENCE query_history_id_seq TO authenticated;
